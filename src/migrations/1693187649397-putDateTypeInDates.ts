...
export class PutDateTypeInDates1693187649397 implements MigrationInterface {
    name = 'PutDateTypeInDates1693187649397'
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.query(`ALTER TABLE "users" ADD "deletedAt" date DEFAULT now()`);
    }
